...
public class Proses3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tProses3 = (TextView)findViewById(R.id.txtproses3);
        ...
        Typeface proses3 = Typeface.createFromAsset(getAssets(), "font/AddisAbaba.ttf");
        tProses3.setTypeface(proses3);
    ...
    public void Play(View view) {
        muatVideo("bPZbxaycO5Y?start=180");
    }
