...
public class Jenis2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jenis2);
        ...
        Typeface jenis2 = Typeface.createFromAsset(getAssets(), "font/CandyCake-gxEyP.ttf");
